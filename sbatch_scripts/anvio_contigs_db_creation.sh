...
#SBATCH --output=/work_beegfs/sunam233/day3/5_anvio_profiles/anvio_contigs_db_creation.out
#SBATCH --error=/work_beegfs/sunam233/day3/5_anvio_profiles/anvio_contigs_db_creation.err
...
anvi-gen-contigs-database -f contigs.anvio.fa -o /work_beegfs/sunam233/day3/5_anvio_profiles/contigs.db -n 'biol217'
